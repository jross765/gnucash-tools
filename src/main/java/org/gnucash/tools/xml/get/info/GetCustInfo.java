...
public class GetCustInfo extends CommandLineTool
{
  // Logger
  @SuppressWarnings("unused")
  private static final Logger LOGGER = LoggerFactory.getLogger(GetCustInfo.class);
...
//    getConfigSettings(cfg);
  ...
  protected void kernel() throws Exception
  {
    ...
    if ( mode == Helper.Mode.ID )
    {
      ...
      if ( cust == null )
      {
        System.err.println("Found no customer with that ID");
  ...
  protected void printUsage()
  {
	...
	try
	{
		formatter.printHelp( "GetCustInfo", "", options, "", true );
	}
	catch ( IOException e )
	{

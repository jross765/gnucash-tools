...
public class GenBdgt extends CommandLineTool
{
  // Logger
  @SuppressWarnings("unused")
  private static final Logger LOGGER = LoggerFactory.getLogger(GenBdgt.class);
...
//    getConfigSettings(cfg);
  ...
  protected void printUsage()
  {
	...
	try
	{
		formatter.printHelp( "GenBdgt", "", options, "", true );
	}
	catch ( IOException e )
	{
